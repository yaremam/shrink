...
| Backend   | `backend/`   | Go + [huma](https://huma.rocks/), PostgreSQL | Skeleton — stack chosen, not yet initialized |
...
- Initializing the Go backend, Flutter client, and Astro marketing
  projects
